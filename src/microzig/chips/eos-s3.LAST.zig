...
pub const devices = struct {
    ...
    pub const @"EOS-S3" = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const EXTM4Regs = @as(*volatile types.peripherals.EXTM4Regs, @ptrFromInt(0x40000000));
            ///  Packet FFO Bank control
            pub const PKFB = @as(*volatile types.peripherals.PKFB, @ptrFromInt(0x40002000));
            ///  Power Management Unit
            pub const PMU = @as(*volatile types.peripherals.PMU, @ptrFromInt(0x40002000));
            ///  Clock Reset Unit
            pub const CRU = @as(*volatile types.peripherals.CRU, @ptrFromInt(0x40004000));
            ///  Interrupt Controller
            pub const INTR_CTRL = @as(*volatile types.peripherals.INTR_CTRL, @ptrFromInt(0x40004800));
            ///  IO Multiplexing Control
            pub const IOMUX = @as(*volatile types.peripherals.IOMUX, @ptrFromInt(0x40004c00));
            ///  MISC registers
            pub const MISC = @as(*volatile types.peripherals.MISC, @ptrFromInt(0x40005000));
            ///  Analog IP block
            pub const AIP = @as(*volatile types.peripherals.AIP, @ptrFromInt(0x40005400));
            ///  Analog-to-Digital Converter
            pub const ADC = @as(*volatile types.peripherals.ADC, @ptrFromInt(0x40005a00));
            ///  Simple Periodic Timer
            pub const SPT = @as(*volatile types.peripherals.SPT, @ptrFromInt(0x40005c00));
            ///  Selects source APB Master to SPI Master between M4/AP and Fabric
            pub const A1_Regs = @as(*volatile types.peripherals.A1_Regs, @ptrFromInt(0x40006000));
            ///  SPI peripheral control
            pub const SPI = @as(*volatile types.peripherals.SPI, @ptrFromInt(0x40007000));
            ///  Direct Memory Access peripheral
            pub const DMA = @as(*volatile types.peripherals.DMA, @ptrFromInt(0x40007400));
            ///  I2S Slave
            pub const I2S_Slave = @as(*volatile types.peripherals.I2S_Slave, @ptrFromInt(0x4000b000));
            ///  System Direct Access Memory
            pub const SDMA = @as(*volatile types.peripherals.SDMA, @ptrFromInt(0x4000c000));
            ///  System Direct Memory Access Bridge
            pub const SDMA_Bridge = @as(*volatile types.peripherals.SDMA_Bridge, @ptrFromInt(0x4000d000));
            ///  System DMA SRAM
            pub const SDMA_SRAM = @as(*volatile types.peripherals.SDMA_SRAM, @ptrFromInt(0x4000f000));
            ///  Universal Asynchronous Receiver Transmitter
            pub const UART = @as(*volatile types.peripherals.UART, @ptrFromInt(0x40010000));
            ///  WatchDog Timer
            pub const WDT = @as(*volatile types.peripherals.WDT, @ptrFromInt(0x40012000));
            ///  Timer peripheral
            pub const TIMER = @as(*volatile types.peripherals.TIMER, @ptrFromInt(0x40013000));
            ///  PIF Register (FPGA Programming interface)
            pub const CFG_CTL = @as(*volatile types.peripherals.CFG_CTL, @ptrFromInt(0x40014000));
            ///  Audio Subsystem
            pub const AUD = @as(*volatile types.peripherals.AUD, @ptrFromInt(0x40015000));
            ///  Flexible Fusion Engine registers
            pub const ExtRegsFFE = @as(*volatile types.peripherals.ExtRegsFFE, @ptrFromInt(0x4004a000));
            ///  Communication Manager - Top Level controller
            pub const SPI_TLC = @as(*volatile types.peripherals.SPI_TLC, @ptrFromInt(0x40050000));

            //pub const DMA_SPI_MS = @as(*volatile types.peripherals.DMA_SPI_MS, @ptrFromInt(0x4000_7400));
    ...
    pub const peripherals = struct {
        ...
        pub const AIP = extern struct {
            ...
            LDO_30_CTRL_0: mmio.Mmio(packed struct(u32) {
                ...
                DIS: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable LDO_30 output
                        enable = 0x0,
                        ///  Disable LDO_30 output
                        disable = 0x1,
                    },
                },
                ...
                DISPG: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable LDO_30 power good comparator
                        enable = 0x0,
                        ///  Disable LDO_30 power good comparator
                        disable = 0x1,
                    },
                },
            ...
            LDO_50_CTRL_0: mmio.Mmio(packed struct(u32) {
                ...
                DIS: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable LDO_50 output
                        enable = 0x0,
                        ///  Disable LDO_50 output
                        disable = 0x1,
                    },
                },
                ///  Used to disable the power good comparator
                DISPG: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable LDO_50 power good comparator
                        enable = 0x0,
                        ///  Disable LDO_50 power good comparator
                        disable = 0x1,
                    },
                },
                ///  Configures the control for maximum expected current imax current (mA)
                IMAX: packed union {
                    raw: u3,
                    value: enum(u3) {
                        ///  Configure the maximum current for LDO_50 as 50mA
                        max_50mA_current = 0x0,
                        ///  Configure the maximum current for LDO_50 as 30mA
                        max_30mA_current = 0x1,
                        ///  Configure the maximum current for LDO_50 as 20mA
                        max_20mA_current = 0x2,
                        ///  Configure the maximum current for LDO_50 as 12mA (default)
                        max_12mA_current = 0x3,
                        ///  Configure the maximum current for LDO_50 as 8mA
                        max_8mA_current = 0x4,
                        ///  Configure the maximum current for LDO_50 as 4mA
                        max_4mA_current = 0x5,
                        ///  Configure the maximum current for LDO_50 as 2mA
                        max_2mA_current = 0x6,
                        ///  Configure the maximum current for LDO_50 as 1mA
                        max_1mA_current = 0x7,
                    },
                },
                ///  Output voltage programming. Note: Please keep LDO_30_DI and LDO_50_DI to be equal values for proper operation and lower power consumption.
                DI: packed union {
                    raw: u5,
                    value: enum(u5) {
                        ///  Configures the LDO_50 output voltage as 0.75v
                        as_0_75v_output = 0x0,
                        ///  Configures the LDO_50 output voltage as 0.77v
                        as_0_77v_output = 0x1,
                        ///  Configures the LDO_50 output voltage as 0.79v
                        as_0_79v_output = 0x2,
                        ///  Configures the LDO_50 output voltage as 0.81v
                        as_0_81v_output = 0x3,
                        ///  Configures the LDO_50 output voltage as 0.83v
                        as_0_83v_output = 0x4,
                        ///  Configures the LDO_50 output voltage as 0.85v
                        as_0_85v_output = 0x5,
                        ///  Configures the LDO_50 output voltage as 0.87v
                        as_0_87v_output = 0x6,
                        ///  Configures the LDO_50 output voltage as 0.89v
                        as_0_89v_output = 0x7,
                        ///  Configures the LDO_50 output voltage as 0.91v
                        as_0_91v_output = 0x8,
                        ///  Configures the LDO_50 output voltage as 0.93v
                        as_0_93v_output = 0x9,
                        ///  Configures the LDO_50 output voltage as 0.95v
                        as_0_95v_output = 0xa,
                        ///  Configures the LDO_50 output voltage as 0.97v
                        as_0_97v_output = 0xb,
                        ///  Configures the LDO_50 output voltage as 0.99v
                        as_0_99v_output = 0xc,
                        ///  Configures the LDO_50 output voltage as 1.01v
                        as_1_01v_output = 0xd,
                        ///  Configures the LDO_50 output voltage as 1.03v
                        as_1_03v_output = 0xe,
                        ///  Configures the LDO_50 output voltage as 1.05v
                        as_1_05v_output = 0xf,
                        ///  Configures the LDO_50 output voltage as 1.07v
                        as_1_07v_output = 0x10,
                        ///  Configures the LDO_50 output voltage as 1.09v (default)
                        as_1_09v_output = 0x11,
                        ///  Configures the LDO_50 output voltage as 1.11v
                        as_1_11v_output = 0x12,
                        ///  Configures the LDO_50 output voltage as 1.13v
                        as_1_13v_output = 0x13,
                        ///  Configures the LDO_50 output voltage as 1.15v
                        as_1_15v_output = 0x14,
                        ///  Configures the LDO_50 output voltage as 1.17v
                        as_1_17v_output = 0x15,
                        ///  Configures the LDO_50 output voltage as 1.19v
                        as_1_19v_output = 0x16,
                        ///  Configures the LDO_50 output voltage as 1.21v
                        as_1_21v_output = 0x17,
                        _,
                    },
                },
        ...
        pub const AUD = extern struct {
            ...
            VOICE_CONFIG: mmio.Mmio(packed struct(u32) {
                ...
                PDM_VOICE_SCENARIO: packed union {
                    raw: u3,
                    value: enum(u3) {
                ...
                PDM_MIC_SWITCH_TO_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Don't switch to AP
                        no_switch = 0x0,
                ...
                LPSD_VOICE_DETECTED_MASK: packed union {
                    raw: u1,
                    value: enum(u1) {
                ...
                ///  Control the masking of the interrupt
                DMIC_VOICE_DETECTED_MASK: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Unmask the interrupt
                        unmask = 0x0,
                ...
                ///  Control the masking of the interrupt
                DMAC_BLK_DONE_MASK: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Unmask the interrupt
                        unmask = 0x0,
                ...
                ///  Control the masking of the interrupt
                DMAC_BUF_DONE_MASK: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Unmask the interrupt
                        unmask = 0x0,
                ...
                ///  Control the masking of the interrupt
                AP_PDM_CLK_IB_MASK: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Unmask the interrupt
                        unmask = 0x0,
                ...
                ///  Control the masking of the interrupt
                AP_PDM_CLK_OFF_MASK: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Unmask the interrupt
                        unmask = 0x0,
        ...
        pub const CRU = extern struct {
            ...
            CLK_CTRL_A_0: mmio.Mmio(packed struct(u32) {
                ...
                Enable_Clock_Divider: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock divider is OFF, Output Source clock directly
                        disable = 0x0,
                        ///  Clock divider is ON
                        enable = 0x1,
                    },
            ...
            CLK_CTRL_A_1: mmio.Mmio(packed struct(u32) {
                ...
                Clock_Source_Selection: packed union {
                    raw: u2,
                    value: enum(u2) {
            ...
            C01_CLK_GATE: mmio.Mmio(packed struct(u32) {
                ///  To A0
                Path_0_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
                ...
                ///  To SDMA SRAM
                Path_1_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
                ...
                ///  To packet FIFO
                Path_2_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
                ...
                ///  To FFE
                Path_3_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
                ...
                Path_4_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
                ...
                Path_5_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
                ...
                ///  To SDMA
                Path_6_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
                ...
                ///  Not specified
                Path_7_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
                ...
                reserved9: u1,
                ///  For SPT
                Path_9_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
            ...
            PF_SW_RESET: mmio.Mmio(packed struct(u32) {
                ...
                PF_FIFO_0_SW_RESET: packed union {
                    raw: u1,
                    value: enum(u1) {
                ...
                ///  1'b1 : Enable the Software Reset. FW need to disable it manually.
                PF_FIFO_1_SW_RESET: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable the software reset. FW need to disable it manually
                        enable = 0x1,
                ...
                ///  1'b1 : Enable the Software Reset. FW need to disable it manually.
                PF_FIFO_2_SW_RESET: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable the software reset. FW need to disable it manually
                        enable = 0x1,
                ...
                ///  1'b1 : Enable the Software Reset. FW need to disable it manually.
                PF_FIFO_8k_SW_RESET: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable the software reset. FW need to disable it manually
                        enable = 0x1,
                ...
                PF_ASYNC_FIFO_0_SW_RESET: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable the software reset. FW need to disable it manually
                        enable = 0x1,
                ...
                ///  1'b1 : Enable the Software Reset. FW need to disable it manually.
                PF_Peripheral_SW_RESET: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable the software reset. FW need to disable it manually
                        enable = 0x1,
            ...
            FFE_SW_RESET: mmio.Mmio(packed struct(u32) {
                ...
                FFE_0_X1_SW_Reset: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable the software reset. FW need to disable it manually. (R01_P3_FFE as well)
                        enable = 0x1,
                        _,
                    },
                },
            ...
            FB_SW_RESET: mmio.Mmio(packed struct(u32) {
                ///  1'b1 : Enable the Software Reset. FW need to disable it manually.
                FB_C02_Domain_SW_Reset: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable the software reset. FW need to disable it manually
                        enable = 0x1,
                ...
                reserved2: u1,
                ///  1'b1 : Enable the Software Reset. FW need to disable it manually.
                FB_C09_Domain_SW_Reset: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable the software reset. FW need to disable it manually
                        enable = 0x1,
                ...
                reserved4: u1,
                ///  1'b1 : Enable the Software Reset. FW need to disable it manually.
                FB_C16_Domain_SW_Reset: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable the software reset. FW need to disable it manually
                        enable = 0x1,
                ...
                ///  1'b1 : Enable the Software Reset. FW need to disable it manually.
                FB_C21_Domain_SW_Reset: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable the software reset. FW need to disable it manually
                        enable = 0x1,
            ...
            FB_MISC_SW_RST_CTL: mmio.Mmio(packed struct(u32) {
                ...
                PFAFIFO1_SW_RESET: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Enable the software reset. FW need to disable it manually
                        enable = 0x1,
            ...
            C30_C31_CLK_GATE: mmio.Mmio(packed struct(u32) {
                ///  To PDM LEFT CLK
                C30_Path_0_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
                ...
                ///  To PDM RIGHT CLK
                C30_Path_1_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
                ...
                ///  To I2S Master Clk
                C30_Path_2_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
                ...
                ///  To LPSD clk
                C31_Path_0_Gating_Control: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Clock is stop
                        stop = 0x0,
        ...
        pub const DMA = extern struct {
            ...
            DMA_INTR_MASK: mmio.Mmio(packed struct(u32) {
                ...
                rx_data_available_mask: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt
                        mask = 0x0,
                ...
                ahb_bridge_fifo_overflow_mask: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt
                        mask = 0x0,
        ...
        pub const ExtRegsFFE = extern struct {
            ...
            INTERRUPT_EN: mmio.Mmio(packed struct(u32) {
                ...
                SM_MULT_WR_INTR_EN: packed union {
                    raw: u1,
                    value: enum(u1) {
                ...
                reserved4: u2,
                ///  Set to enable the interrupt, leave cleared to mask
                FFE0_SM1_OVERRUN_EN: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Set to enable the interrupt, leave cleared to mask
                FFE0_SM0_OVERRUN_EN: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Set to enable the interrupt, leave cleared to mask
                I2C_MS_1_ERROR_EN: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Set to enable the interrupt, leave cleared to mask
                I2C_MS_0_ERROR_EN: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Set to enable the interrupt, leave cleared to mask
                FFE0_BP_MATCH_INTR_EN: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Set to enable the interrupt, leave cleared to mask
                SM0_BP_MATCH_INTR_EN: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Set to enable the interrupt, leave cleared to mask
                SM1_BP_MATCH_INTR_EN: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Set to enable the interrupt, leave cleared to mask
                ahbm_bus_error_intr_en: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
            ...
            FFE_DEBUG_SEL: mmio.Mmio(packed struct(u32) {
                ...
                FFE_TOP_DEBUG_SEL: packed union {
                    raw: u2,
                    value: enum(u2) {
                        ///  Select sm0
                        sm0 = 0x0,
        ...
        pub const I2S_Slave = extern struct {
            ...
            I2S_COMP_PARAM_1: mmio.Mmio(packed struct(u32) {
                ...
                I2S_FIFO_DEPTH_GLOBAL: packed union {
                    raw: u2,
                    value: enum(u2) {
                ...
                I2S_TX_WORDSIZE_0: packed union {
                    raw: u3,
                    value: enum(u3) {
        ...
        pub const INTR_CTRL = extern struct {
            ...
            GPIO_INTR_EN_AP: mmio.Mmio(packed struct(u32) {
                ...
                GPIO_0_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                ...
                GPIO_1_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_2_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_3_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_4_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_5_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_6_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_7_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
            ...
            GPIO_INTR_EN_M4: mmio.Mmio(packed struct(u32) {
                ...
                GPIO_1_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_2_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_3_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_4_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_5_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_6_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_7_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
            ...
            GPIO_INTR_EN_FFE0: mmio.Mmio(packed struct(u32) {
                ...
                GPIO_0_INTR_EN_FFE0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_1_INTR_EN_FFE0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_2_INTR_EN_FFE0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_3_INTR_EN_FFE0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_4_INTR_EN_FFE0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_5_INTR_EN_FFE0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_6_INTR_EN_FFE0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_7_INTR_EN_FFE0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
            ...
            GPIO_INTR_EN_FFE1: mmio.Mmio(packed struct(u32) {
                ...
                GPIO_0_INTR_EN_FFE1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_1_INTR_EN_FFE1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_2_INTR_EN_FFE1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_3_INTR_EN_FFE1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_4_INTR_EN_FFE1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_5_INTR_EN_FFE1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_6_INTR_EN_FFE1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                GPIO_7_INTR_EN_FFE1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
            ...
            OTHER_INTR_EN_AP: mmio.Mmio(packed struct(u32) {
                ...
                M4_SRAM_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                TIMEOUT_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                SPI_MS_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                CFG_DMA_DONE_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                PMU_TMR_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_INTR_OTHERS_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                LDO30_PG_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                LDO50_PG_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                SRAM_128KB_TIMEOUT_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                LPSD_VOICE_DET_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                DMIC_VOICE_DET_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
            ...
            OTHER_INTR_EN_M4: mmio.Mmio(packed struct(u32) {
                ...
                M4_SRAM_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                TIMEOUT_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                SPI_MS_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                CFG_DMA_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                PMU_TMR_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_INTR_OTHERS_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                APBOOT_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                LDO30_PG_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                LDO50_PG_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                LPSD_VOICE_DET_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                DMIC_VOICE_DET_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
            ...
            FFE_INTR_EN_AP: mmio.Mmio(packed struct(u32) {
                ...
                FFE0_0_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_1_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_2_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_3_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_4_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_5_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_6_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_7_INTR_EN_AP: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
            ...
            FFE_INTR_EN_M4: mmio.Mmio(packed struct(u32) {
                ...
                FFE0_0_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_1_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_2_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_3_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_4_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_5_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_6_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
                ...
                FFE0_7_INTR_EN_M4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the interrupt for the power domain
                        enable = 0x0,
        ...
        pub const MISC = extern struct {
            ...
            SUBSYS_DBG_MON_SEL: mmio.Mmio(packed struct(u32) {
                ...
                SUBSYS_DEBUG_MON_SEL: packed union {
                    raw: u3,
                    value: enum(u3) {
            ...
            A0_PMU_DBG_MON_SEL: mmio.Mmio(packed struct(u32) {
                ...
                A0_PMU_DEBUG_MON_SEL: packed union {
                    raw: u6,
                    value: enum(u6) {
        ...
        pub const PKFB = extern struct {
            ...
            PKFB_FIFOCTRL: mmio.Mmio(packed struct(u32) {
                ...
                ///  Select which subsystem manages the push interrupt
                pf8k_push_int_mux: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Select the M4 subsystem to control the FIFO
                        m4 = 0x0,
            ...
            PKFB_PF0PUSHCTL: mmio.Mmio(packed struct(u32) {
                ...
                pf0_push_sleep_type: packed union {
                    raw: u1,
                    value: enum(u1) {
                ...
                pf0_push_int_en_ov: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                pf0_push_int_en_thresh: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                pf0_push_int_en_sram_sleep: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
            ...
            PKFB_PF0POPCTL: mmio.Mmio(packed struct(u32) {
                ...
                pf0_pop_sleep_en: u1,
                ///  Select the type of sleep mode
                pf0_pop_sleep_type: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Select deep sleep as sleep type for the FIFO
                        deep_sleep = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO overflow is enabled or masked
                pf0_pop_int_en_ov: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO threshold is enabled or masked
                pf0_pop_int_en_thresh: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                pf0_pop_int_en_sram_sleep: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
            ...
            PKFB_PF1PUSHCTL: mmio.Mmio(packed struct(u32) {
                ...
                ///  Select the type of sleep mode
                pf1_push_sleep_type: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Select deep sleep as sleep type for the FIFO
                        deep_sleep = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO overflow is enabled or masked
                pf1_push_int_en_ov: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO threshold is enabled or masked
                pf1_push_int_en_thresh: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for push on SRAM sleep is enabled or masked
                pf1_push_int_en_sram_sleep: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
            ...
            PKFB_PF1POPCTL: mmio.Mmio(packed struct(u32) {
                ...
                pf1_pop_sleep_en: u1,
                ///  Select the type of sleep mode
                pf1_pop_sleep_type: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Select deep sleep as sleep type for the FIFO
                        deep_sleep = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO overflow is enabled or masked
                pf1_pop_int_en_ov: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO threshold is enabled or masked
                pf1_pop_int_en_thresh: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for pop on SRAM sleep is enabled or masked
                pf1_pop_int_en_sram_sleep: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
            ...
            PKFB_PF2PUSHCTL: mmio.Mmio(packed struct(u32) {
                ...
                ///  Select the type of sleep mode
                pf2_push_sleep_type: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Select deep sleep as sleep type for the FIFO
                        deep_sleep = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO overflow is enabled or masked
                pf2_push_int_en_ov: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO threshold is enabled or masked
                pf2_push_int_en_thresh: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for push on SRAM sleep is enabled or masked
                pf2_push_int_en_sram_sleep: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
            ...
            PKFB_PF2POPCTL: mmio.Mmio(packed struct(u32) {
                ...
                pf2_pop_sleep_en: u1,
                ///  Select the type of sleep mode
                pf2_pop_sleep_type: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Select deep sleep as sleep type for the FIFO
                        deep_sleep = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO overflow is enabled or masked
                pf2_pop_int_en_ov: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO threshold is enabled or masked
                pf2_pop_int_en_thresh: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for pop on SRAM sleep is enabled or masked
                pf2_pop_int_en_sram_sleep: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
            ...
            PKFB_PF8KPUSHCTL: mmio.Mmio(packed struct(u32) {
                ...
                ///  Select the type of sleep mode
                pf8k_push_sleep_type: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Select deep sleep as sleep type for the FIFO
                        deep_sleep = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO overflow is enabled or masked
                pf8k_push_int_en_ov: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO threshold is enabled or masked
                pf8k_push_int_en_thresh: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for push on SRAM sleep is enabled or masked
                pf8k_push_int_en_sram_sleep: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
            ...
            PKFB_PF8KPOPCTL: mmio.Mmio(packed struct(u32) {
                ...
                ///  Select the type of sleep mode
                pf8k_pop_sleep_type: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Select deep sleep as sleep type for the FIFO
                        deep_sleep = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO overflow is enabled or masked
                pf8k_pop_int_en_ov: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for FIFO threshold is enabled or masked
                pf8k_pop_int_en_thresh: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
                ...
                ///  Control whether the push interrupt for pop on SRAM sleep is enabled or masked
                pf8k_pop_int_en_sram_sleep: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
            ...
            PKFB_FIFO_COLL_INTR_EN: mmio.Mmio(packed struct(u32) {
                ...
                ///  Set bit to enable interrupt
                pf8k_coll_intr_en: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt event
                        mask = 0x0,
        ...
        pub const PMU = extern struct {
            ...
            MISC_POR_1: mmio.Mmio(packed struct(u32) {
                ...
                Sys_rst_as_int_pw: packed union {
                    raw: u2,
                    value: enum(u2) {
                ...
                Sys_rst_pulse_ext: packed union {
                    raw: u1,
                    value: enum(u1) {
            ...
            MISC_POR_2: mmio.Mmio(packed struct(u32) {
                ...
                SPI_Reboot_enable_N: packed union {
                    raw: u1,
                    value: enum(u1) {
                ...
                ///  If 1'b0, Need cfgSM to reload the code when M4 waking up from SD (Mode1) FW needs to clear this bit if needs code reloading from SPI flash once waking up from SD mdoe (MODE1). CfgSM will be kick off if code reloading from SPI flash needed. This is for code reloading ONLY.
                AP_Reboot_enable_N: packed union {
                    raw: u1,
                    value: enum(u1) {
            ...
            SDMA_POWER_MODE_CFG: mmio.Mmio(packed struct(u32) {
                ...
                SDMA_Power_Mode_Cfg: packed union {
                    raw: u2,
                    value: enum(u2) {
                        ///  Retention Mode
                        retention_mode = 0x1,
            ...
            M4_PWR_MODE_CFG: mmio.Mmio(packed struct(u32) {
                ...
                M4_Power_Mode_Cfg: packed union {
                    raw: u2,
                    value: enum(u2) {
            ...
            FFE_PWR_MODE_CFG: mmio.Mmio(packed struct(u32) {
                ///  FW need to configure the registers before kicking off the power down event.
                FFE_Power_Mode_Cfg: packed union {
                    raw: u2,
                    value: enum(u2) {
            ...
            FFE_PD_SRC_MASK_N: mmio.Mmio(packed struct(u32) {
                ...
                FFE_PD_Event_Mask: packed union {
                    raw: u1,
                    value: enum(u1) {
            ...
            FFE_WU_SRC_MASK_N: mmio.Mmio(packed struct(u32) {
                ...
                KickOff_Timer_Time_Out: packed union {
                    raw: u1,
                    value: enum(u1) {
                ...
                Sensor_GPIO_0_INT: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt as a wake-up event source
                        mask = 0x0,
                ...
                Sensor_GPIO_1_INT: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt as a wake-up event source
                        mask = 0x0,
                ...
                Sensor_GPIO_2_INT: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt as a wake-up event source
                        mask = 0x0,
                ...
                Sensor_GPIO_3_INT: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt as a wake-up event source
                        mask = 0x0,
                ...
                Sensor_GPIO_4_INT: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt as a wake-up event source
                        mask = 0x0,
                ...
                Sensor_GPIO_5_INT: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt as a wake-up event source
                        mask = 0x0,
                ...
                Sensor_GPIO_6_INT: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt as a wake-up event source
                        mask = 0x0,
                ...
                Sensor_GPIO_7_INT: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the interrupt as a wake-up event source
                        mask = 0x0,
            ...
            FB_PWR_MODE_CFG: mmio.Mmio(packed struct(u32) {
                ///  FW need to configure the registers before kicking off the power down event.
                FB_Power_Mode_Cfg: packed union {
                    raw: u2,
                    value: enum(u2) {
                        ///  Configure power down event for deep sleep mode
                        deep_sleep_mode = 0x1,
            ...
            FB_PD_SRC_MASK_N: mmio.Mmio(packed struct(u32) {
                ...
                Interface_Signal_0: packed union {
                    raw: u1,
                    value: enum(u1) {
                ...
                Interface_Signal_1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the signal as a power-down event source
                        mask = 0x0,
                ...
                Interface_Signal_2: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the signal as a power-down event source
                        mask = 0x0,
                ...
                Interface_Signal_3: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the signal as a power-down event source
                        mask = 0x0,
            ...
            PF_PWR_MODE_CFG: mmio.Mmio(packed struct(u32) {
                ...
                PF_Power_Mode_Cfg: packed union {
                    raw: u2,
                    value: enum(u2) {
                        ///  Configure power down event for deep sleep mode
                        deep_sleep_mode = 0x1,
            ...
            M4S0_PWR_MODE_CFG: mmio.Mmio(packed struct(u32) {
                ///  FW need to configure the registers before kicking off the power down event
                M4S0_Power_Mode_Cfg: packed union {
                    raw: u2,
                    value: enum(u2) {
                        ///  Configure power down event for shut down mode
                        shut_down_mode = 0x2,
            ...
            M4S0_PD_SRC_MASK_N: mmio.Mmio(packed struct(u32) {
                ...
                M4S0_PD_Event_Mask: packed union {
                    raw: u1,
                    value: enum(u1) {
            ...
            A1_PWR_MODE_CFG: mmio.Mmio(packed struct(u32) {
                ///  FW need to configure the registers before kicking off the power down event
                A1_Power_Mode_Cfg: packed union {
                    raw: u2,
                    value: enum(u2) {
                        ///  Retention Mode
                        retention_mode = 0x1,
            ...
            A1_WU_SRC_MASK_N: mmio.Mmio(packed struct(u32) {
                ...
                A1_WU_EVENT_MASK_M: packed union {
                    raw: u1,
                    value: enum(u1) {
            ...
            AUDIO_WU_SRC_MASK_N: mmio.Mmio(packed struct(u32) {
                ...
                AD0_WU_Event_Mask_N: packed union {
                    raw: u1,
                    value: enum(u1) {
                ...
                ///  Allow external interrupt coming from pads 9 or 30 to serve as wake-up event trigger
                AD1_WU_Event_Mask_N: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the external interrupts from pads 9 or 30 as wake-up event triggers
                        mask = 0x0,
                ...
                ///  Allow external interrupt coming from pads 9 or 30 to serve as wake-up event trigger
                AD2_WU_Event_Mask_N: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the external interrupts from pads 9 or 30 as wake-up event triggers
                        mask = 0x0,
                ...
                ///  Allow external interrupt coming from pads 9 or 30 to serve as wake-up event trigger
                AD3_WU_Event_Mask_N: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the external interrupts from pads 9 or 30 as wake-up event triggers
                        mask = 0x0,
                ...
                ///  Allow external interrupt coming from pads 9 or 30 to serve as wake-up event trigger
                AD4_WU_Event_Mask_N: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the external interrupts from pads 9 or 30 as wake-up event triggers
                        mask = 0x0,
                ...
                ///  Allow external interrupt coming from pads 9 or 30 to serve as wake-up event trigger
                AD5_WU_Event_Mask_N: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Mask the external interrupts from pads 9 or 30 as wake-up event triggers
                        mask = 0x0,
            ...
            M4_MEM_CTRL_0: mmio.Mmio(packed struct(u32) {
                ...
                CTRL_M4_SRAM_DS_0: packed union {
                    raw: u1,
                    value: enum(u1) {
                ...
                CTRL_M4_SRAM_DS_1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_2: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_3: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_5: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_6: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_7: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_8: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_9: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_10: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_11: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_12: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_13: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_14: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_M4_SRAM_DS_15: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
            ...
            M4_MEM_CTRL_1: mmio.Mmio(packed struct(u32) {
                ...
                CTRL_M4_SRAM_SD_0: packed union {
                    raw: u1,
                    value: enum(u1) {
                ...
                CTRL_M4_SRAM_SD_1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_M4_SRAM_SD_2: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_M4_SRAM_SD_3: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_M4_SRAM_SD_4: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_M4_SRAM_SD_5: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_M4_SRAM_SD_6: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_M4_SRAM_SD_7: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_M4_SRAM_SD_8: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_M4_SRAM_SD_9: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_M4_SRAM_SD_10: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                ///  Control SD pin of 32KB SRAM Instance 10 on M4 subsystem
                CTRL_M4_SRAM_SD_11: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                ///  Control SD pin of 32KB SRAM Instance 10 on M4 subsystem
                CTRL_M4_SRAM_SD_12: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                ///  Control SD pin of 32KB SRAM Instance 10 on M4 subsystem
                CTRL_M4_SRAM_SD_13: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                ///  Control SD pin of 32KB SRAM Instance 10 on M4 subsystem
                CTRL_M4_SRAM_SD_14: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                ///  Control SD pin of 32KB SRAM Instance 10 on M4 subsystem
                CTRL_M4_SRAM_SD_15: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
            ...
            PF_MEM_CTRL_1: mmio.Mmio(packed struct(u32) {
                ...
                CTRL_PF_SRAM_SD_0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_PF_SRAM_SD_8k: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
            ...
            FFE_MEM_CTRL_0: mmio.Mmio(packed struct(u32) {
                ...
                CTRL_FFE_SRAM_DS_CM0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_FFE_SRAM_DS_DM0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_FFE_SRAM_DS_DM1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_FFE_SRAM_DS_SM0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_FFE_SRAM_DS_SM1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_FFE_SRAM_DS_CM1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                CTRL_FFE_SRAM_DS_DM2: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                ///  Control DS pin of CM0 1Kx32
                CTRL_FFE_SRAM_DS_DM3: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
            ...
            FFE_MEM_CTRL_1: mmio.Mmio(packed struct(u32) {
                ...
                CTRL_FFE_SRAM_SD_CM0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_FFE_SRAM_SD_DM0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_FFE_SRAM_SD_DM1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_FFE_SRAM_SD_SM0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_FFE_SRAM_SD_SM1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_FFE_SRAM_SD_CM1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                CTRL_FFE_SRAM_SD_DM2: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                ///  Control SD pin of CM0 1Kx32
                CTRL_FFE_SRAM_SD_DM3: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
            ...
            AUDIO_MEM_CTRL_0: mmio.Mmio(packed struct(u32) {
                ...
                AUDIO_SRAM_LC_DS_0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                AUDIO_SRAM_LC_DS_1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                AUDIO_SRAM_LC_DS_2: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                AUDIO_SRAM_RC_DS_0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                AUDIO_SRAM_RC_DS_1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
                ...
                AUDIO_SRAM_RC_DS_2: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the Deep Sleep function of SRAM Macro, Memory content will be kept.
                        disable_deep_sleep = 0x0,
            ...
            AUDIO_MEM_CTRL_1: mmio.Mmio(packed struct(u32) {
                ...
                AUDIO_SRAM_LC_SD_0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                AUDIO_SRAM_LC_SD_1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                AUDIO_SRAM_LC_SD_2: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                AUDIO_SRAM_RC_SD_0: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                AUDIO_SRAM_RC_SD_1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
                ...
                AUDIO_SRAM_RC_SD_2: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable the shut down function of SRAM Macro.
                        disable_shut_down = 0x0,
            ...
            FFE_MEM_CFG: mmio.Mmio(packed struct(u32) {
                ...
                CFG_FFE_SRAM_LS_0: packed union {
                    raw: u1,
                    value: enum(u1) {
                ...
                CFG_FFE_SRAM_LS_1: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable, never put SRAM into Light Sleep mode.
                        disable_light_sleep = 0x0,
                ...
                CFG_FFE_SRAM_LS_2: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable, never put SRAM into Light Sleep mode.
                        disable_light_sleep = 0x0,
                ...
                CFG_FFE_SRAM_LS_3: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Disable, never put SRAM into Light Sleep mode.
                        disable_light_sleep = 0x0,
            ...
            M4_SRAM_SW_PD: mmio.Mmio(packed struct(u32) {
                ...
                ///  Set to trigger a power down event. Bit is cleared after power down sequence finishes
                M4S10_Software_PD: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Put the power domain to power saving mode according to configuration setting, HW will clear it once power down sequence is finished.
                        power_down = 0x1,
                ...
                ///  Set to trigger a power down event. Bit is cleared after power down sequence finishes
                M4S11_Software_PD: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Put the power domain to power saving mode according to configuration setting, HW will clear it once power down sequence is finished.
                        power_down = 0x1,
                ...
                ///  Set to trigger a power down event. Bit is cleared after power down sequence finishes
                M4S12_Software_PD: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Put the power domain to power saving mode according to configuration setting, HW will clear it once power down sequence is finished.
                        power_down = 0x1,
                ...
                ///  Set to trigger a power down event. Bit is cleared after power down sequence finishes
                M4S13_Software_PD: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Put the power domain to power saving mode according to configuration setting, HW will clear it once power down sequence is finished.
                        power_down = 0x1,
                ...
                ///  Set to trigger a power down event. Bit is cleared after power down sequence finishes
                M4S14_Software_PD: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Put the power domain to power saving mode according to configuration setting, HW will clear it once power down sequence is finished.
                        power_down = 0x1,
                ...
                ///  Set to trigger a power down event. Bit is cleared after power down sequence finishes
                M4S15_Software_PD: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  Put the power domain to power saving mode according to configuration setting, HW will clear it once power down sequence is finished.
                        power_down = 0x1,
            ...
            M4_SRAM_SW_WU: mmio.Mmio(packed struct(u32) {
                ...
                ///  Set to trigger a wake up event. Bit is cleared after wake up sequence finishes
                M4S10_Software_WU: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  wake up power domain, HW will clear it once power up sequence is finished.
                        wake_up = 0x1,
                ...
                ///  Set to trigger a wake up event. Bit is cleared after wake up sequence finishes
                M4S11_Software_WU: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  wake up power domain, HW will clear it once power up sequence is finished.
                        wake_up = 0x1,
                ...
                ///  Set to trigger a wake up event. Bit is cleared after wake up sequence finishes
                M4S12_Software_WU: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  wake up power domain, HW will clear it once power up sequence is finished.
                        wake_up = 0x1,
                ...
                ///  Set to trigger a wake up event. Bit is cleared after wake up sequence finishes
                M4S13_Software_WU: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  wake up power domain, HW will clear it once power up sequence is finished.
                        wake_up = 0x1,
                ...
                ///  Set to trigger a wake up event. Bit is cleared after wake up sequence finishes
                M4S14_Software_WU: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  wake up power domain, HW will clear it once power up sequence is finished.
                        wake_up = 0x1,
                ...
                ///  Set to trigger a wake up event. Bit is cleared after wake up sequence finishes
                M4S15_Software_WU: packed union {
                    raw: u1,
                    value: enum(u1) {
                        ///  wake up power domain, HW will clear it once power up sequence is finished.
                        wake_up = 0x1,
            ...
            M4SRAM_SSW_LPMH_MASK_N: mmio.Mmio(packed struct(u32) {
                ...
                M4SRAM_LPMH_MASK_N: packed union {
                    raw: u16,
                    value: enum(u16) {
        ...
        pub const DMA_SPI_MS = extern struct {
            DMA_CTRL: mmio.Mmio(packed struct(u32) {
                padding: u32,
            }),
            DMA_DEST_ADDR: mmio.Mmio(packed struct(u32) {
